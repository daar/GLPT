 ...
 *
 * Darius Blaszyk
 *   - Conversion to GLPT (24 September 2017)
 *)
    ...
    case event^.mcode of
      ...
      begin
        ...
        case event^.params.keyboard.keycode of
          ...
          GLPT_KEY_UP: view_rotx += 5.0;
          GLPT_KEY_DOWN: view_rotx -= 5.0;
          GLPT_KEY_LEFT: view_roty += 5.0;
          GLPT_KEY_RIGHT: view_roty -= 5.0;
        end;
      end;
      GLPT_MESSAGE_RESIZE:
      begin
...
begin
  ...
  while not GLPT_WindowShouldClose(win) do
  begin
    draw;
